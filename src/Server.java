...
public class Server {
    ...
    private static final int port = 5666; // порт для подключения
    private static final Serialization serialization = new Serialization(); // сериализптор/десериализатор
    private static final LocalDateTime today = LocalDateTime.now(); //
    //private static final String serializedDate = "home/s308489/lab7/serializedDate.txt";
    private static final String serializedDate = "C:\\Users\\Евгений\\IdeaProjects\\ProgLab7-main\\src\\Files\\serializedDate.txt"; // файл для передачи сериализованных сообщений
    /**
     * Это main)
     *
     * @param args - что-то
     ...
     */
    public static String read() throws IOException, ExecutionException, InterruptedException {
    ...
    public static void authorisation() throws ExecutionException, InterruptedException {
        while (true) {
            try {
    ...
    //@Override
    protected String compute() throws ExecutionException, InterruptedException {
        String message = null;
        try {
            message = read();
        } catch (IOException e) {
